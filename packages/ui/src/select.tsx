...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "placeholderM placeholder:text-text-tertiary focus:outline-text-secondary  flex w-full justify-between rounded-xl border border-neutral-200 bg-transparent px-4 py-3 text-lg outline-transparent transition-colors",
      className,
    )}
    {...props}
  >
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "placeholderM hover:border-text-secondary flex w-full  cursor-pointer justify-between  rounded-xl border border-transparent bg-transparent px-4 py-3  text-lg outline-none transition-colors hover:outline-none",
      className,
    )}
    {...props}
  >
